...
def generate_image(store_offers):
    try:
        name, icon, price = store_offers
        ...
        skin1_resize = Image.open(BytesIO(skin1.content)).resize((490, 120))
        skin2_resize = Image.open(BytesIO(skin2.content)).resize((490, 120))
        skin3_resize = Image.open(BytesIO(skin3.content)).resize((490, 120))
        skin4_resize = Image.open(BytesIO(skin4.content)).resize((490, 120))
